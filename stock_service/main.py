...
# Speedup of 5.0 means data is replayed 5 faster than real-time
csv_file = "data_with_ts_ms.csv"
if not Path(csv_file).exists():
    logger.error(f"CSV file not found: {csv_file}")
    raise FileNotFoundError(f"CSV file not found: {csv_file}")

logger.info(f"Reading historical data from {csv_file}")
logger.info("Replay configuration: speedup = 5.0 (5x faster than real-time)")
...
# ============================================================================
# Timestamp Output Transformation
# ============================================================================
# Extract just the datetime string for the stock_timestamp topic
logger.info("Transforming data for timestamp Kafka output")
...
try:
    ...
    logger.info("Kafka timestamp writer configured successfully")
except Exception as e:
    logger.error(f"Failed to configure Kafka timestamp writer: {str(e)}", exc_info=True)
    raise
